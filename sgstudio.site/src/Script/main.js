...
const page = {
  "Home": () => {
      ...
      <div class="navb-item navb-position">
        ...
        <div class="nitem-selector d-none d-lg-flex">
          ...
          <div class="nitem-ssocial d-none d-lg-flex">
            ...
            <button onCLick="mdOpen('https://www.instagram.com')"><i class="fa-xl fa-brands fa-instagram"></i><div class="sunderline"></div></button>
            <button onClick="mdOpen('https://www.youtube.comAykunCraft')"><i class="fa-xl fa-brands fa-youtube"></i><div class="sunderline"></div></button>
          </div>
        </div>
    ...
    pgfun.Add(`<div class="Copyringht">
      <p>Copyright ⒸAykunCraft <span onClick="mdHref('')"></span> | Made In Indonesia❤️‍🔥</p>
    </div>`)
    ...
    const rtextList = ['AykunCraft', 'AykunCraft', 'AykunCraft5566', 'Aykun', 'Craft'];
    const rtextConfig = {
      "delayWriteIn": 65,
      "delayDeteleIn": 40,
      "delayWaitt": {
